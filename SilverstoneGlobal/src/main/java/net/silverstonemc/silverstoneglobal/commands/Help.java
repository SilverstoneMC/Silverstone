        ...
        switch (plugin.getConfig().getString("server").toLowerCase()) {
            ...
            case "creative" -> sender.sendMessage(Component.empty().append(Component.text("\nCommands:",
                ...
                .append(Component.text("\n/p2 claim ", NamedTextColor.AQUA)
                    .clickEvent(ClickEvent.clickEvent(ClickEvent.Action.RUN_COMMAND, "/p2 claim"))).append(
                ...
                .append(Component.text("\n/p2 set ", NamedTextColor.AQUA)
                    .clickEvent(ClickEvent.clickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/p2 set "))).append(
